...
Type:: The unit type of the unit (see xref:basics:units-and-unit-types.adoc[]).
...
For information about the second value, see xref:main-rules:assault-moves-and-charges.adoc[].
footnote:[
