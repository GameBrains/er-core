...
You can choose which enemy units to apply hits against but as with shooting you can only put a second hit on a unit once all of the enemy units in base contact have been allocated one hit each.
// IJW editing note: tweaked to use more consistent references to base contact.
