...
Or, it may be that some units are not mobile, so you can't move them anyway.footnote:[Non-mobile units include those which have a Speed value of '0 cm' or `-`, or that are subject to a rule that says that you 'may not move' them. The Retreat move rules do not override this.]
