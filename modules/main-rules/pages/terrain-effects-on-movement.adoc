...
When you wish to move a unit into dangerous terrain, or when you wish to move a unit that is already in dangerous terrain, roll a D6: On a roll of 1, halt the unit. If the unit is moving into terrain, halt at the edge of the terrain.
If the unit is halted, roll the D6 again: If you roll another 1 then the unit takes a hit.
// IJW EDITING NOTE: I took out 'in this way' because covering both types of halt made it ambiguous.
...
That is, up to 30 cm for the first two moves that are on roads ((10 cm first Speed value + 5 cm road bonus) x2), plus up to 10 cm for the third move that is over at least some open ground.
====

.Assault movement on roads
====
An Ork Boyz Infantry unit is on Assault orders.
Ork Boyz have a Speed value of 10/20 cm.

The player will make an assault move entirely on a road.

The player could make a charge move of 30 cm, or a normal assault move of 15 cm.

That is, a charge move up to 30 cm (20 cm second Speed value + 10 cm road bonus), or a normal assault move up to 15 cm (10 cm first Speed value + 5 cm road bonus).
====
