...
{blank}[TODO: Consider more detail either here or by reference to another topic. See link:https://thehobby.zone/resources/e40k-compendium/Content/More/HouseRulesFrequentlyAskedQuestionsAndOtherNonsense/FAQ_Cover.htm[FAQ: Cover^] (external URL).]
