...
* The Space Marine unit has a Speed value of `10 cm`.
As an Infantry unit, you can double this value to `20 cm` where you use the extra movement to make a charge move.
+
