...
* Unless your unit is subject to a 'may not move' restriction then you *must* move it at least 5 cm -- or into base contact with an enemy unit that is within 5 cm.
Any movement beyond this is optional.
* This move *must* be as directly as possible towards an enemy unit.
