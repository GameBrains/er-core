...
====
The requirement to move at least 5 cm or into base contact does not override any rules that prevent the unit from moving, for example if the detachment fails a Leadership test to move, or the unit fails the first part of a Dangerous terrain test.
====
