...
* Don't place Blast markers on out of command units.footnote:[pass:m[The main reason for this is to avoid excessive penalties when you use the xref:battles:scenario-special-rules:army-morale.adoc[\] rules.]]
