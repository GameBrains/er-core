...
====
+
. At the end of the Movement phase, the transport flyers take off with their cargo and disengage -- remove them from the playing area {blank}[TODO: ..."and place them in the Re-arm state"?].
