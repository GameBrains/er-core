...
{blank}[TODO: Do we need to state something to the effect that flyers that are on a mission do not enter the Repair or Re-arm states until after any Counter-strikes are resolved?]
+
...
. After you complete the attack, place your units in the Re-arm state.
