...
[NOTE]
====
We explain the phases at xref:the-sequence-of-play.adoc[]. For the moment, suffice to say that most movement happens in the Movement phase, most shooting happens in the Shooting phase, and so on.
====
