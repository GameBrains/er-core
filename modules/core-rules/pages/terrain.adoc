...
The effects often differ between *unit types*, as you will find in the <<TerrainTable>>.
...
Some terrain may block the line of sight between opposing units.
This isn't always as clear-cut as you might think, so it pays to talk about particular terrain pieces and principles with your opponent before you start the battle.
...
We represent this with a bonus that increases the Armour value of any infantry unit that is in such terrain -- see the *Infantry Armour Bonus* column in the <<TerrainTable>>.
