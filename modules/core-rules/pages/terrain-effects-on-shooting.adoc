...
We represent this with a bonus that increases the Armour value of any infantry unit that is in such terrain -- see the *Infantry Armour Bonus* column at <<terrain-table>>.
