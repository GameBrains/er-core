...
During the Movement phase *only*, if your opponent moves a unit such that it passes within 10cm of one of your units then you may make a Snap-fire attack:
...
. Your opponent must 'backtrack' to place the unit at the point where it first comes within 10cm of one of your units.
