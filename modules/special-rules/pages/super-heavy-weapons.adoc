...
Where a game effect forces you to halve the Firepower of a detachment or unit, you also suffer a reduction in the effectiveness of its super-heavy weaponsfootnote:[Common game effects that force you to halve Firepower include Assault orders and some particular critical damage effects for War Engine units.].
...
Normally, for each Blast marker on a detachment you must reduce its Firepower by 1.
...
// [TODO: Define suppression properly, perhaps in blast-markers.adoc -- as it is we use the term and imply its meaning, but haven't actually made it explicit.]

NOTE: The entire super-heavy weapon is suppressed, even if it has multiple shots like {pulsar}, or adds to a detachment's Firepower like {barrage}.

== Super-heavy weapons in firefights

Where a super-heavy weapon doesn't have a basic Firepower value, but is in a position to contribute to a firefight, it contributes 1 Firepower.
{blank}[TODO: Is it just firefights? Do SHWs count as FP1 in any other situations, like supporting fire in close combat?]
