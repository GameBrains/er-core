...
footnote:[Common game effects that force you to halve Firepower include Assault orders and some particular critical damage effects for War Engine units.]
