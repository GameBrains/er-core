...
Critical damage effects that destroy or restrict a weapon mount apply to the whole weapon system carried in that location.
...
Multiple shots from such a weapon system are just like multiples of that super-heavy weapon.
...
* Where a weapon system does not have a basic Firepower value, treat it like a set of super-heavy weapons:
