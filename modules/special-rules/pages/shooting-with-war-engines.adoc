...
The actual game effects of weapon systems are as follows:
...
* Where a weapon system does not have a basic Firepower value, treat it as a single super-heavy weapon and apply all the rules as normal for a single super-heavy weapon:
+
...
You may only use weapons in that weapon system against targets that are within that arc.
