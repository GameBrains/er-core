...
{blank}}[TODO: Clarify what happens if their detachment becomes Broken. Presumably, we cannot make a Withdrawal move with these units, so they'll be especially vulnerable in this situation.]
