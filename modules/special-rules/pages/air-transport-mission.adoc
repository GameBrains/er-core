...
+
{blank}[IJW reply: Yes, there are. A 60 mm round base (fairly common for stability purposes) makes it impossible to disembark units on 20 mm square or 25 mm round bases, and even strip bases barely squeeze in by a few mm. There are also 115 x 90 mm oval bases that are sometimes used for SM Landing Craft, or bigger Ork Landa conversions. I suggest using the standard disembarkation rules,  and add a restriction that any landing Flyers can't place their bases within 10 cm of enemy units, or within terrain impassible to vehicles.]
...
+
{blank}[IJW reply: It doesn't make any difference, there is no 'sequence' of that kind in 3rd.]
