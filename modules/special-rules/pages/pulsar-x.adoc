...
IMPORTANT: Remember, {pulsar-x} represents a single super-heavy weapon -- the salvo of {macro-weapon} shots that result do *not* count as multiple super-heavy weapons for placement of Blast markers, suppression, contribution to firefights, or any other game purpose.
