...
Each die that scores equal to or more than the Armour value of the target unit will damage or destroy the unit.
.. Resolve damage immediately and then move on to the next attack. (See xref:damaging-flyers.adoc[])
