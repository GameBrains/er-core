...
.. Roll a number of hit dice equal to the Gunnery value of your attacking unit.
...
* link:https://thehobby.zone/resources/e40k-compendium/Content/More/HouseRulesFrequentlyAskedQuestionsAndOtherNonsense/FAQ_InterceptingInterceptors.htm[FAQ: Intercepting interceptors^] (external URL)
