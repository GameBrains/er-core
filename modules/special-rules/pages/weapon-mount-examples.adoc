...
.Weapon mounts
====
The Imperial Baneblade super-heavy tank has one weapon mount:

* *Main Weapons* (All Round arc).
This mount holds a ranged super-heavy weapon named Turret Guns.
The weapon arc is All Round.

The Imperial Warlord Titan is more complex.
It has four weapon mounts:

* *Left Arm* (Left 180° arc); *Right Arm* (Right 180° arc); *Left Carapace* and *Right Carapace* (both Front 90° arc).
+
...
* *Left Arm* and *Right Arm* (both Front 90° arc).
