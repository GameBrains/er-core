...
** When your detachment's Firepower is halved for any reason, roll to *lock on* with each of its super-heavy weapon system shots.
...
** After Firepower, each remaining Blast marker suppresses one super-heavy weapon system shot.
** In a firefight, a super-heavy weapon system contributes 1 Firepower per shot. The total value will usually be shown in brackets on the data sheet.
endif::[]