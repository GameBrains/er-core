...
The purpose of {project-name} is to provide an enhanced version of the original {e40k} game rules and army lists.
...
However, we have a principle that we intend to keep at the forefront at all times; that is:

[none]
* To *respect and retain the distinct nature of the {e40k} game system* -- we want to present the {e40k} system of gameplay at its best, not create a derivative with substantial differences in gameplay.
...
There are some minor differences in terminology, and where {e40k} defines some army-specific rules in its army lists, we've rationalised and redefined these in the xref:core:special-rules:special-abilities.adoc[] section instead -- but that's about all that you'll need to adjust to.
****
