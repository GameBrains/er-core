...
_Italic_ font style: We use this to emphasise the title of a publication or product.

·Dot markers·: We use these to emphasise and disambiguate the names of special abilities.
//TODO: Find a better approach — these dots are a compromise. When I try to use Asciidoc or HTML markup to add styling information to attributes in the playbook, the PDF output processor throws command line errors that break the build. I've tried various approaches to a solution, and none work. It may become easier in a future updates to Antora Assembler/PDF extension.]
...
====
.Related information
* xref:core:main-rules:data-sheets-and-characteristics.adoc[]
* Experimental: xref:core:experimental:experimental.adoc[]
====
